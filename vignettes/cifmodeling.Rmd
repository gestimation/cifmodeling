...
This package is a compact and unified toolkit for Kaplan–Meier / Aalen–Johansen curves, visualization, and direct polytomous regression based on polytomous log odds products in R. 

```{r example0-1, warning=FALSE, message=FALSE}
