...
-   `print.panel` Logical. When `TRUE`, the composed patchwork object is printed automatically in interactive sessions; otherwise the object is returned invisibly so it can be assigned, modified, or saved. Kept for backward compatibility.
