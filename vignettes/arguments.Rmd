...
-   `error` Character specifying the method for standard error and confidence intervals used internally. `"greenwood"` (default), `"tsiatis"` or `"if"` for `"survival"`, and `"delta"` (default), `"aalen"` or `"if"` for `"competing-risk"`).
