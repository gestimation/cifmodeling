...
-   `error` Character string specifying the method for SEs and CIs used internally. For `"survival"`, choose one of `"greenwood"` (default), `"tsiatis"`, or `"if"`. For `"competing-risk"`, choose one of `"delta"` (default), `"aalen"`, or `"if"`.
