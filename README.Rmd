...
-   **Data visualization**
    ...
    -   `add.estimate.table` adds estimated survival probabilities or CIFs and CIs at each point in time
...
-   A List that in contains **patchwork** object (still ggplot-compatible).
...
>>>>>>> 5459d5253c6439e8a444f9884fb61a9dca74fca4
