...
```{r example1-6, warning=FALSE, message=FALSE}
...
```{r example3-1, warning=FALSE, message=FALSE}
...
```{r example3-2, warning=FALSE, message=FALSE}
...
```{r example4-1, warning=FALSE, message=FALSE}
cifpanel(
