...
-   `polyreg()` fits coherent regression models of CIFs based on polytomous log odds products and the stratified inverse probability of censoring weighting (IPCW) estimator. 
