...
> See the [Gallery](articles/gallery.html) for a curated set of examples using `cifplot()` and `cifpanel()`.

> **Learn the modeling framework with `polyreg()`:**  
> See the [Direct polytomous regression](articles/polyreg.html) for coherent, joint modeling of all cause-specific CIFs.
