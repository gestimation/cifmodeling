...
#'
#' @param add.ci Logical; if \code{TRUE}, adds a confidence-interval ribbon
...
#'   (default \code{2}).
#'
#' @param add.quantile Logical; if \code{TRUE}, adds a quantile line (via
#'   \code{ggsurvfit::add_quantile()}). Default \code{FALSE}.
#' @param level.quantile Numeric quantile to be shown (default \code{0.5} for median).
#'
