...
#' @param na.action Function to handle missing values (default: \code{na.omit}).
...
#' @param code.event1 Integer code of the event of interest.
#' @param code.event2 Integer code of the competing event.
#' @param code.censoring Integer code of censoring.
