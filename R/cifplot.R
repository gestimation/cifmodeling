...
#' |---|---|---|
#' | `add.ci` | Add confidence interval ribbon. | `TRUE` |
...
#' | `add.quantile` | Add quantile lines. | `FALSE` |
#' | `level.quantile` | Quantile for `add.quantile`. | `0.5` |
#'
#' #### Time for marks
#'
...
#' @param add.ci Logical add \code{add_confidence_interval()} to plot. It calls geom_ribbon() (default \code{TRUE}).
...
#' @param level.quantile Numeric specify quantile for \code{add_quantile()} (default \code{0.5}).
