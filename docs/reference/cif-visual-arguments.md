# These arguments are shared by [`cifplot()`](https://gestimation.github.io/cifmodeling/reference/cifplot.md) and [`cifpanel()`](https://gestimation.github.io/cifmodeling/reference/cifpanel.md).
